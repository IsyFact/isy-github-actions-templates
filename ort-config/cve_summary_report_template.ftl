...
[#assign Unknown = Unknown + vulnerabilities?filter(vuln -> vuln.references[0]?? && vuln.references[0].severityRating?? && vuln.references[0].severityRating == "UNKNOWN")?size]
[#assign Low = Low + vulnerabilities?filter(vuln -> vuln.references[0]?? && vuln.references[0].severityRating?? && vuln.references[0].severityRating == "LOW")?size]
[#assign Medium = Medium + vulnerabilities?filter(vuln -> vuln.references[0]?? && vuln.references[0].severityRating?? && vuln.references[0].severityRating == "MEDIUM")?size]
[#assign High = High + vulnerabilities?filter(vuln -> vuln.references[0]?? && vuln.references[0].severityRating?? && vuln.references[0].severityRating == "HIGH")?size]
[#assign Critical = Critical + vulnerabilities?filter(vuln -> vuln.references[0]?? && vuln.references[0].severityRating?? && vuln.references[0].severityRating == "CRITICAL")?size]
[/#list]
[/#list]
