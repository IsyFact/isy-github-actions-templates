...
Wenn der Workflow durch einen Pull Request gestartet wurde, verarbeitet er das als Artefakt veröffentlichte Antora-Log und bereitet es im Markdown-Format auf, um eine Übersicht des Builds und relevanter Log-Einträge als PR-Kommentar zu veröffentlichen.
